...
- @MacArthur1967 montrent mathématiquement que la richesse spécifique (le nombre d'espèces) d'une île est un équilibre dynamique entre le taux d'immigration et le taux d'extinction, ce dernier étant directement dicté par la taille de l'île –\> théorie sur la biogéographie des îles (plus une île est loin de la côte moins il y a d'espèces car moins de migration , plus une île plus il y a de la dérive et donc moins d'espèce)
